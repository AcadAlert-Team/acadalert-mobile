  ...
  useFocusEffect(
    useCallback(() => {
      ...
      fetch(backendURL, {
        ...
        .then(async (res) => {
          // 1. Trap the text before it crashes!
          const rawText = await res.text();
          console.log("🚨 ATTENDANCE SECRET MESSAGE:", rawText);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Detailed breakdown and ML inferences.
        </Text>
      </View>
      ...
      >
        {subjectData.map(sub => (
          <View key={sub.id} style={styles.card}>
            ...
            <Text style={styles.attendanceFraction}>
              {sub.attended} / {sub.held} classes attended
            </Text>
...
const styles = StyleSheet.create({
  ...
  bgRed: { backgroundColor: '#FA5252' },
  bgOrange: { backgroundColor: '#FD7E14' },
  bgGreen: { backgroundColor: '#40C057' },
  progressBarBg: {
    height: 8,
